...
namespace ConsoleAppTeste
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var ClasseNormal = new ClasseNormal { varivaelClasseNormal = 26 };
            Console.WriteLine("Uso da classe Normal: " + ClasseNormal.varivaelClasseNormal);
            ...
            ClasseSingleton variavelSingleton = ClasseSingleton.Instancia;
    ...
    {
        public int varivaelClasseNormal;
    }
